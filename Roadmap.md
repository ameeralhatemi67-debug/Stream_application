...
| 1.0.2 P2 truthful data and real actions | Reopened | Production simulations were removed and real actions wired, but admin Overview KPIs still show sample numbers (found 2026-09-23). No device or production-database run exists. |
