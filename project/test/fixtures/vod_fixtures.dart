// Test-only fixtures: the sample VOD archive and playlists that used to be
// compiled into lib/ and served whenever a streamer had no real recordings
// (P2 truthful data). The app now shows an empty state instead.
